<section class="section section_padding section__advantages">
    ...
    <div class="advantages clearfix">
        <div class="advantages__inner advantages__inner--left">
            ...
            <div class="inner inner--price">
                <span class="inner__title">Адекватные цены</span>
                <p class="inner__txt">Вы покупаете качественный дизайн по “оптовой” цене, так как работаю без посредников и выполняю работу сама. Не выставляю дополниельных условий и платежей после утверждения сделки.</p>
            </div>
            <div class="inner inner--pay">
                <span class="inner__title">Удобство платежа</span>
        ...
        <div class="advantages__inner advantages__inner--right">
            ...
            <div class="inner inner--limit">
                <span class="inner__title">Нет лимита на правки</span>
                <p class="inner__txt">У меня нет конкретного числа правок. Работаю до достижения желаемого результата. При этом соблюдаю оговоренные сроки. Вы можете быть уверены, что работа будет красивой, понятной и выгодно отличит вас от конкурентов.</p>
            </div>  
        </div>
    </div>
</section>	